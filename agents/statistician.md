---
name: statistician
description: Statistical rigor advisor: experimental design, signal-vs-noise, pressure-testing metric claims, sample-size and confounder review. Use when designing evals, judging telemetry/dashboard metrics, or validating AI-sprint measurement claims before presenting them.
...
---
*Adapted from the [agency-agents](https://github.com/msitarzewski/agency-agents) template (MIT) and reworked for this collection.*
