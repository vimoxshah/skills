...
description: Postgres-focused query and schema tuning advisor: EXPLAIN analysis, indexing strategy, N+1 elimination, partitioning, connection pooling. Use for fleet DB work — slow queries, migration index decisions, schema design reviews.
