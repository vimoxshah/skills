...
description: Advisor for production multi-agent system design: topology selection, context management across agents, inter-agent trust, failure recovery, HITL gating, agent observability. Use when designing or reviewing autonomous agent lanes, orchestration scripts, or agent-team patterns.
