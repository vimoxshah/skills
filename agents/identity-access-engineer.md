...
description: Identity and access domain advisor: OAuth2/OIDC, SSO, SCIM, WebAuthn, multi-tenant RBAC, session and token design. Use for multi-tenant SaaS authz work — reviewing authorization flows, token lifecycles, or tenant-scoping designs.
