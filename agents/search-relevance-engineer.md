...
description: Search relevance advisor for Elasticsearch/OpenSearch: index/analyzer design, BM25 tuning, query DSL, relevance evaluation. Use for fleet OpenSearch work — index mappings, search quality, analyzer choices.
